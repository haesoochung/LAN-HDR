...
class Generator(nn.Module):
    ...
    def forward(self, inputs, input_ys, input_exp_ys, hdr=None):
        ...
        aligned_5, gate5 = self.align(inputs[5], input_ys[5], inputs[self.mid], input_exp_ys[5])
        aligned_6, gate6 = self.align(inputs[6], input_ys[6], inputs[self.mid], input_exp_ys[6])
        output = self.merge([aligned_0, aligned_1, aligned_2, aligned_3, aligned_4, aligned_5, aligned_6])

        return output, [gate0, gate1, gate2, gate3, gate4, gate5, gate6]
